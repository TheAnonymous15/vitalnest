...
<div class="fixed top-5 right-5 z-50 flex items-center gap-3">
    ...
    <?php else: ?>
        <a href="/patient" target="_blank" class="hidden sm:flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-vital-orange to-amber-500 rounded-full text-white font-bold text-sm shadow-lg shadow-vital-orange/25 hover:shadow-vital-orange/40 hover:-translate-y-0.5 transition-all duration-300">
...
<nav id="floating-nav" class="fixed left-1/2 -translate-x-1/2 z-50">
    <div class="relative">
        ...
        <div class="relative flex items-center gap-1 px-2 py-2 bg-slate-900/80 backdrop-blur-2xl rounded-full border border-white/10 shadow-2xl shadow-black/40">
            ...
            <a href="/patient" target="_blank" class="nav-item group relative px-4 py-2.5 rounded-full transition-all duration-300">
                <div class="flex items-center gap-2">
...
<div id="mobile-nav" class="fixed inset-0 z-[100] pointer-events-none lg:hidden">
    ...
    <div id="mobile-nav-content" class="absolute inset-0 flex flex-col opacity-0 scale-95 transition-all duration-500">
        ...
        <div class="px-6 py-6 space-y-4">
            ...
            <?php else: ?>
                <a href="/patient" target="_blank" class="flex items-center justify-center gap-2 p-4 bg-gradient-to-r from-vital-orange to-amber-500 rounded-2xl text-white font-bold shadow-lg">
                    <span>Get Started Free</span>
                    <i class="fas fa-arrow-right"></i>
                </a>
                <p class="text-center text-white/40 text-sm">
                    Already have an account? <a href="/patientlogin" target="_blank" class="text-vital-teal hover:underline font-semibold">Sign In</a>
                </p>
            <?php endif; ?>
        </div>
    </div>
