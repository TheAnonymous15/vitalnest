...
define('SITE_WHATSAPP', '254746511327');
...
define('SMTP_USERNAME', ''); // Your email - UPDATE THIS
...
define('MPESA_CONSUMER_KEY', ''); // Get from Safaricom Developer Portal - UPDATE THIS
define('MPESA_CONSUMER_SECRET', ''); // UPDATE THIS
define('MPESA_SHORTCODE', ''); // Your Paybill/Till number - UPDATE THIS
define('MPESA_PASSKEY', ''); // UPDATE THIS
