...
async function loadCurrentPlan() {
    ...
    try {
        const response = await fetch(`' + window.location.origin + '/api/subscriptions/subscription?user_id=${userId}`);
...
async function confirmCancellation() {
    ...
    try {
        const response = await fetch('' + window.location.origin + '/api/subscriptions/cancel', {
            method: 'POST',
