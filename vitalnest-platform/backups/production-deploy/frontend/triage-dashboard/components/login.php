...
<head>
    ...
    <title>VitalNest - Triage Portal</title>
...
<body>
    ...
    <div class="data-stream" style="top: 70%; animation-delay: 6s;">█████ TRIAGE_PORTAL_v2.0 █████</div>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-6 fade-in delay-2">
                ...
                <div class="inline-flex items-center gap-3 mt-3 px-4 py-1.5 holo-card rounded-full">
                    ...
                    <span class="text-cyan-400 text-xs font-mono">ID: 3890</span>
                </div>
            </div>
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success && data.data.token) {
                    ...
                    document.cookie = `triage_token=${data.data.token}; path=/; max-age=28800; SameSite=Strict`;

                    // Store user data
                    localStorage.setItem('triage_token', data.data.token);
                    // removed duplicate token storage
                    localStorage.setItem('triage_user', JSON.stringify(data.data.user));
