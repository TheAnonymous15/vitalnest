                    ...
                    <div class="fade-in delay-4">
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="email"
                                name="email"
                                value="pharmacist@vitalnest.com"
                                required
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success && data.data.token) {
                    ...
                    document.cookie = `pharmacy_token=${data.data.token}; path=/; max-age=28800; SameSite=Strict`;

                    // Store user data
                    localStorage.setItem('pharmacy_token', data.data.token);
                    // removed duplicate token storage
                    localStorage.setItem('pharmacy_user', JSON.stringify(data.data.user));
