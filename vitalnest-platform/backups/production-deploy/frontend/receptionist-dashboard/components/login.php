                    ...
                    <div class="fade-in delay-4">
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="email"
                                name="email"
                                value="receptionist@vitalnest.com"
                                required
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success && data.data.token) {
                    ...
                    document.cookie = `receptionist_token=${data.data.token}; path=/; max-age=28800; SameSite=Strict`;

                    // Store user data
                    localStorage.setItem('receptionist_token', data.data.token);
                    // removed duplicate token storage
                    localStorage.setItem('receptionist_user', JSON.stringify(data.data.user));
