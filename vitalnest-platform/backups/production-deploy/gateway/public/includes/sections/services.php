                    ...
                    <div class="relative bg-white/[0.08] backdrop-blur-2xl rounded-3xl p-8 border border-white/20 overflow-hidden shadow-2xl">
                        ...
                        <div class="relative">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <a href="http://localhost:3456/" target="_blank" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-vital-teal to-teal-600 text-white rounded-xl font-bold text-sm hover:shadow-lg hover:shadow-vital-teal/40 hover:-translate-y-0.5 transition-all duration-300 group">
