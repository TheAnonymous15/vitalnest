                    ...
                    <div class="lg:col-span-2 relative">
                        <div class="h-full bg-gradient-to-br from-vital-teal/20 to-teal-900/40 backdrop-blur-xl rounded-3xl p-8 border border-vital-teal/20 overflow-hidden">
                            ...
                            <div class="relative">
                                ...
                                <a href="http://localhost:3456/" target="_blank" class="block w-full py-3 bg-vital-teal text-white font-bold rounded-xl hover:bg-teal-600 transition-all duration-300 text-center">
                    ...
                    <div class="lg:col-span-2 relative">
                        <div class="h-full bg-gradient-to-br from-vital-orange/20 to-orange-900/40 backdrop-blur-xl rounded-3xl p-8 border border-vital-orange/20 overflow-hidden">
                            ...
                            <div class="relative">
                                ...
                                <a href="http://localhost:3456/" target="_blank" class="block w-full py-3 bg-vital-orange text-white font-bold rounded-xl hover:bg-orange-600 transition-all duration-300 text-center">
                                    Get Started <i class="fas fa-arrow-right ml-2"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-2 relative">
                        <div class="h-full bg-gradient-to-br from-rose-500/20 to-pink-900/40 backdrop-blur-xl rounded-3xl p-8 border border-rose-500/20 overflow-hidden">
                            ...
                            <div class="relative">
                                ...
                                <a href="http://localhost:3456/" target="_blank" class="block w-full py-3 bg-rose-500 text-white font-bold rounded-xl hover:bg-rose-600 transition-all duration-300 text-center">
                                    Get Started <i class="fas fa-arrow-right ml-2"></i>
                                </a>
                            </div>
                        </div>
